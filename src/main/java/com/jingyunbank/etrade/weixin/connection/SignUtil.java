package com.jingyunbank.etrade.weixin.connection;
...
public class SignUtil {
	private static final String token = "legu";
	/**
	 ...
	 * @return
	 */
	public static boolean validSign(String signature, String timestamp, String nonce) {
