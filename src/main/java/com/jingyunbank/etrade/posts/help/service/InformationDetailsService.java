...
import com.jingyunbank.etrade.api.posts.help.service.IInformationDetailsService;
import com.jingyunbank.etrade.config.CacheConfig;
import com.jingyunbank.etrade.posts.help.dao.InformationDetailsDao;
import com.jingyunbank.etrade.posts.help.entity.InformationDetailsEntity;
@Service
public class InformationDetailsService implements IInformationDetailsService{
	...
	//通过siteid查询对应的多条信息内容
	@Override
	@Cacheable(cacheNames = "informationDetailsCache", keyGenerator = CacheConfig.CUSTOM_CACHE_KEY_GENERATOR)
