...
public class ManagerOrderQueryController {
	...
	/**
	 * get /api/orders/manager/0/10?keywords=东阿&status=PAID&fromdate=2015-11-09&mid=xzxcvzx
	 *	
	 ...
	 */
	@AuthBeforeOperation
	@RequestMapping(value="/api/orders/manager/list", method=RequestMethod.GET)
	...
	/**
	 * get /api/orders/manager/count?keywords=东阿&status=PAID&fromdate=2015-11-09
	 *	
	 * 查询某用户的订单数量
	 * @param uid
	 * @param session
	 * @return
	 */
	@RequestMapping(value="/api/orders/manager/count", method=RequestMethod.GET)
	@AuthBeforeOperation
